...
var CuttingLineDetailShowcaseComponent = (function () {
    function CuttingLineDetailShowcaseComponent(_zone, _route, _productionLineService, _timeNotifyService, _hourConverter) {
        var _this = this;
        this._zone = _zone;
        this._route = _route;
    ...
    CuttingLineDetailShowcaseComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    CuttingLineDetailShowcaseComponent.prototype.getLine = function (id) {
        var _this = this;
    ...
    CuttingLineDetailShowcaseComponent.prototype.getDateInfo = function (date) {
        var _this = this;
    ...
    CuttingLineDetailShowcaseComponent.prototype.getHourlyInfos = function (dateInfo) {
        var _this = this;
    ...
    CuttingLineDetailShowcaseComponent.prototype.setHour = function () {
        if (this.hourlyInfos) {
    ...
    CuttingLineDetailShowcaseComponent.prototype.updateUI = function (productionLine, efficiency) {
        this.line = productionLine;
        this.setEfficiency();
    };
    CuttingLineDetailShowcaseComponent.prototype.setEfficiency = function () {
        this.performance = (this.hourlyInfo.goal / this.hourlyInfo.completed * 100).toFixed(2);
    };
    CuttingLineDetailShowcaseComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return CuttingLineDetailShowcaseComponent;
}());
exports.CuttingLineDetailShowcaseComponent = CuttingLineDetailShowcaseComponent;
//# sourceMappingURL=cutting-line-detail-showcase.component.js.map